export default function Home() {
  return (
    <main className="max-w-3xl mx-auto px-6 py-16">
      ...
      {/* Racing Car */}
      <section className="mb-24">
        <h2 className="text-2xl font-bold mb-6">Built for ambitious drivers</h2>
        <p className="text-lg leading-relaxed mb-4">
          You have ideas. Big ones. But your project can&apos;t keep up. Every change
          takes months. The people who built it moved on. Nobody dares touch what
          they left behind.
        </p>
        <p className="text-lg leading-relaxed mb-4">
...
The Driver    = your team`}
      ...
      <section className="mb-24">
        ...
        <div className="space-y-12">
          ...
          <div>
            <h3 className="text-xl font-semibold mb-2">Build what fits</h3>
            <p className="text-lg leading-relaxed">
              Off-the-shelf software often does too much and fits too little. With AI,
              building a custom tool that matches your exact needs is faster and
              cheaper than you think. You own it. No per-seat pricing. No vendor
              lock-in.
            </p>
          </div>
      ...
      <section className="mb-24">
        ...
        <div className="space-y-6 text-lg leading-relaxed">
          <p>
            <span className="font-semibold">We talk.</span>{" "}
            No pitch deck, no 6-week sales cycle. A conversation about what you
            need and whether we&apos;re the right fit.
          </p>
          <p>
            <span className="font-semibold">We scope it.</span>{" "}
            A clear offer with fixed price, concrete deliverables, and defined
            acceptance criteria. You know what you get and what you pay.
          </p>
          <p>
          ...
          <p>
            ...
            When we&apos;re done, the project is yours. AI-ready, documented, tested.
            Your team continues without us. And if you have the next idea, we&apos;re
            a conversation away.
          </p>
        </div>
      </section>
      ...
      <section className="mb-24">
        ...
        <p className="text-lg leading-relaxed mb-4">
          A collective of senior engineers and consultants who share a common
          approach: AI-native software development. Each of us brings years of
          experience across different industries, tech stacks, and team
          structures.
        </p>
        <p className="text-lg leading-relaxed mb-4">
        ...
        <p className="text-lg leading-relaxed">
          The name is playful. The work is serious. We genuinely enjoy what we
          do, and that energy shows up in how we deliver.
        </p>
      </section>
